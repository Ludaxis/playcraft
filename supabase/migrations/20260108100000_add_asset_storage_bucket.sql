...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'storage'
      ...
      AND policyname = 'Users can read own project assets'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'storage'
      AND tablename = 'objects'
      AND policyname = 'Users can upload own project assets'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'storage'
      AND tablename = 'objects'
      AND policyname = 'Users can update own project assets'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'storage'
      AND tablename = 'objects'
      AND policyname = 'Users can delete own project assets'
  ) THEN
