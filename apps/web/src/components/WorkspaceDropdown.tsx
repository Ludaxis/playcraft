...
export function WorkspaceDropdown({
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div
          className={`absolute z-50 mt-2 overflow-hidden rounded-xl border border-border bg-surface-overlay shadow-xl ${
        ...
        >
            ...
            <div className="border-b border-border p-4">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="rounded-lg bg-accent px-4 py-1.5 text-sm font-medium text-content transition-colors hover:bg-accent-light"
                >
                  Upgrade
                </button>
              </div>
          ...
          <div className="border-b border-border p-4">
            ...
            >
              <span className="font-medium text-content">Credits</span>
              <div className="flex items-center gap-2">
                <span className="text-sm text-content-muted">{creditsRemaining} left</span>
                <ChevronRight
                  className={`h-4 w-4 text-content-subtle transition-transform ${
            ...
            <div className="mt-3">
              <div className="h-2 w-full overflow-hidden rounded-full bg-surface-elevated">
                <div
                  className="h-full rounded-full bg-accent-light transition-all duration-300"
          ...
          {/* All Workspaces */}
          <div className="p-2">
            <p className="mb-2 px-2 text-xs font-medium uppercase tracking-wider text-content-subtle">
              All workspaces
            </p>
