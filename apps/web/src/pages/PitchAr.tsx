        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-6 max-w-5xl mb-3 md:mb-8 px-2">
            ...
            >
              ...
              <p className="text-teal-400 mb-1 md:mb-2 text-xs md:text-sm font-medium">مدیر المنتج</p>
            ...
            >
              ...
              <p className="text-violet-400 mb-1 md:mb-2 text-xs md:text-sm font-medium">مدير التسويق</p>
              <p className="text-content-secondary text-xs hidden md:block leading-relaxed">
            ...
            >
              ...
              <p className="text-blue-400 mb-1 md:mb-2 text-xs md:text-sm font-medium">مدير الأعمال</p>
              <p className="text-content-secondary text-xs hidden md:block leading-relaxed">
