...
// Slide data configuration (Persian labels)
const SLIDES = [
  { id: 'title', label: 'عنوان' },
  { id: 'problem', label: 'مشکل' },
  { id: 'solution', label: 'راه‌حل' },
  { id: 'why-now', label: 'چرا الان' },
  { id: 'product', label: 'محصول' },
  { id: 'moat', label: 'مزیت' },
  { id: 'competition', label: 'رقبا' },
  { id: 'business-model', label: 'مدل درآمد' },
  { id: 'traction', label: 'ترکشن' },
  { id: 'go-to-market', label: 'GTM' },
  { id: 'team', label: 'تیم' },
  { id: 'ask', label: 'درخواست' },
  { id: 'thank-you', label: 'تشکر' },
];

// Competitor data
const COMPETITORS = [
  { name: 'Lovable', focus: 'اپ‌های وب', gaming: 'محدود', color: '#ec4899' },
  { name: 'Bolt.new', focus: 'فول‌استک', gaming: 'محدود', color: '#3b82f6' },
  { name: 'Replit', focus: 'IDE + AI', gaming: 'متوسط', color: '#f59e0b' },
  { name: 'Base44', focus: 'اپ‌های بیزنس', gaming: 'خیلی محدود', color: '#8b5cf6' },
];

export function PitchFaPage() {
      ...
      <div className="w-full h-full">
        ...
        >
          ...
          <p className="text-sm md:text-2xl text-content-secondary mt-3 md:mt-6 font-light text-center px-4 max-w-3xl">
            استودیوی بازی‌سازی با هوش مصنوعی — بساز، منتشر کن، درآمد داشته باش
          </p>
        ...
        >
          <h2 className="text-2xl md:text-5xl font-bold text-content-primary mb-4 md:mb-12">
            ساخت بازی <span className="text-error">سخت است</span>
          </h2>
          <div className="grid grid-cols-3 gap-2 md:gap-8 max-w-5xl px-2">
            <div className="bg-surface-elevated/50 backdrop-blur-sm border border-border-muted rounded-xl md:rounded-2xl p-3 md:p-8 text-center">
              ...
              <p className="text-content-secondary text-xs md:text-base">ماه برای یادگیری Unity/Unreal</p>
            </div>
            <div className="bg-surface-elevated/50 backdrop-blur-sm border border-border-muted rounded-xl md:rounded-2xl p-3 md:p-8 text-center">
              ...
              <p className="text-content-secondary text-xs md:text-base">گیمر، فقط ۱ میلیون توسعه‌دهنده</p>
            </div>
            <div className="bg-surface-elevated/50 backdrop-blur-sm border border-border-muted rounded-xl md:rounded-2xl p-3 md:p-8 text-center">
              ...
              <p className="text-content-secondary text-xs md:text-base">از ایده‌ها هرگز ساخته نمی‌شوند</p>
            </div>
          </div>
          <p className="mt-4 md:mt-12 text-sm md:text-xl text-content-tertiary max-w-2xl text-center px-4">
            فاصله بین تخیل و بازی قابل انتشار خیلی زیاد است.
          </p>
        </div>
        ...
        >
          <h2 className="text-2xl md:text-5xl font-bold text-content-primary mb-2 md:mb-4 text-center">
            بساز. میزبانی کن. <span className="text-accent">درآمد داشته باش.</span>
          </h2>
          <p className="text-sm md:text-xl text-content-secondary mb-4 md:mb-10 text-center px-4">
            پلتفرم کامل بازی‌سازی — از پرامپت تا درآمد
          </p>
          <div className="grid grid-cols-3 gap-2 md:gap-6 max-w-4xl mb-4 md:mb-8 px-2">
            <div className="bg-surface-elevated border border-accent/30 rounded-xl md:rounded-2xl p-3 md:p-6 text-center">
              ...
              <h3 className="text-xs md:text-lg font-semibold text-content-primary mb-1">سازنده</h3>
            ...
            <div className="bg-surface-elevated border border-secondary/30 rounded-xl md:rounded-2xl p-3 md:p-6 text-center">
              ...
              <h3 className="text-xs md:text-lg font-semibold text-content-primary mb-1">اجرا</h3>
            ...
            <div className="bg-surface-elevated border border-warning/30 rounded-xl md:rounded-2xl p-3 md:p-6 text-center">
              ...
              <h3 className="text-xs md:text-lg font-semibold text-content-primary mb-1">درآمدزایی</h3>
        ...
        >
          <h2 className="text-2xl md:text-5xl font-bold text-content-primary mb-4 md:mb-12">
            چرا <span className="text-accent">الان</span>؟
          </h2>
        ...
        >
          <h2 className="text-2xl md:text-5xl font-bold text-content-primary mb-2 md:mb-4 text-center">
            چرا ما <span className="text-accent">برنده می‌شویم</span>
          </h2>
          ...
          <div className="grid grid-cols-2 gap-2 md:gap-4 max-w-4xl px-2">
            ...
            <div className="bg-surface-elevated border border-secondary/30 rounded-lg md:rounded-xl p-2.5 md:p-5">
              ...
              <p className="text-content-secondary text-xs md:text-sm hidden md:block">تلمتری ساخت + اجرا → تولید بهتر، دیباگ خودکار</p>
            ...
            <div className="bg-surface-elevated border border-success/30 rounded-lg md:rounded-xl p-2.5 md:p-5">
              ...
              <p className="text-content-secondary text-xs md:hidden">چسبندگی درآمدزایی</p>
            </div>
          ...
          <p className="mt-3 md:mt-6 text-content-tertiary text-center max-w-2xl text-xs md:text-sm px-4">
            گیمینگ حدود ۵٪ کاربران سازنده‌های افقی است — ارزش سرمایه‌گذاری برای رقابت را ندارد.
          </p>
        </div>
          ...
          <div className="w-full max-w-xs md:hidden px-4">
            <div className="space-y-3">
              <div className="bg-accent/20 border border-accent rounded-xl p-3 text-center">
                ...
                <p className="text-xs text-content-secondary">بدون کد + سازنده بازی</p>
              ...
              <div className="bg-surface-elevated border border-border-muted rounded-xl p-3">
                <p className="text-xs text-content-tertiary mb-2 text-center">سازنده‌های اپ بدون کد</p>
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-2 md:gap-6 max-w-3xl mb-4 md:mb-8 px-2">
            <div className="bg-surface-elevated border border-accent/30 rounded-lg md:rounded-xl p-3 md:p-5">
              ...
              <div className="space-y-1 md:space-y-2 text-xs md:text-sm text-content-secondary">
                ...
                <p className="flex items-center gap-1.5"><Globe className="w-3 h-3 md:w-4 md:h-4 text-accent" /> اعتبار اجرا</p>
                <p className="flex items-center gap-1.5"><Users className="w-3 h-3 md:w-4 md:h-4 text-accent" /> اشتراک تیمی</p>
              </div>
            </div>
          ...
          <p className="text-content-tertiary text-xs md:text-sm text-center">
            بازی بیشتر ← اجرای بیشتر ← درآمد بیشتر ← رشد ترکیبی
          </p>
        </div>
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-2 md:gap-8 max-w-4xl mb-4 md:mb-12 px-2">
            <div className="bg-surface-elevated border border-border-muted rounded-xl md:rounded-2xl p-3 md:p-8 text-center">
              ...
              <p className="text-content-secondary text-xs md:text-base">محصول فعال ساخته شد</p>
            </div>
            <div className="bg-surface-elevated border border-border-muted rounded-xl md:rounded-2xl p-3 md:p-8 text-center">
          ...
          <div className="flex flex-row items-stretch gap-2 md:gap-8 max-w-5xl px-2">
            ...
            <div className="flex-1 bg-surface-elevated border border-warning/30 rounded-lg md:rounded-2xl p-2 md:p-6">
              <div className="flex items-center gap-1.5 md:gap-3 mb-2 md:mb-4">
                ...
                <h3 className="text-xs md:text-xl font-semibold text-content-primary">درآمدزایی</h3>
              </div>
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-6 max-w-5xl mb-3 md:mb-8 px-2">
            ...
            >
              <div className="w-14 h-14 md:w-20 md:h-20 rounded-full mx-auto mb-2 md:mb-3 overflow-hidden bg-cyan-500/20">
                <img src="/founders/sina.png" alt="سینا ملکی" className="w-full h-full object-cover" />
              </div>
              <h3 className="text-xs md:text-lg font-semibold text-content-primary mb-0.5">سینا ملکی</h3>
              <p className="text-cyan-400 mb-1 md:mb-2 text-xs md:text-sm font-medium">مدیر فنی</p>
              <p className="text-content-secondary text-xs hidden md:block leading-relaxed">
          ...
          <div className="bg-surface-elevated/50 border border-border-muted rounded-lg md:rounded-xl p-2.5 md:p-5 max-w-3xl text-center mx-4">
            <p className="text-content-primary font-medium mb-1 text-xs md:text-base">چرا ما؟</p>
            <p className="text-content-secondary text-xs md:text-sm">
              +۶ سال با هم بازی ساختیم. مجموعاً: +۲۵ میلیون بازیکن، +۱۰ عنوان منتشرشده، و خروج از استارتاپ.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <div>
              ...
              <p className="text-content-tertiary text-xs md:text-sm">استودیوی بازی‌سازی با هوش مصنوعی</p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="bg-surface-elevated/50 border border-border-muted rounded-xl md:rounded-2xl p-4 md:p-8 mb-6 md:mb-10 text-center">
            ...
            <p className="text-content-secondary text-sm md:text-lg mb-4">استودیوی بازی‌سازی با هوش مصنوعی</p>
          ...
          <p className="text-content-tertiary text-xs md:text-sm text-center">
            بیایید آینده بازی‌سازی را با هم بسازیم.
          </p>
        </div>
      </div>
    </div>
