      ...
      <div className="bg-bg-inverse py-3 px-4 flex items-center justify-between">
        ...
        <div className="p-4">
          ...
          <div className="space-y-3">
            {/* Facebook */}
            <button className="w-full flex items-center gap-3 bg-border-strong hover:bg-bg-muted rounded-xl py-3 px-4 border-2 border-border">
            ...
            <button className="w-full flex items-center gap-3 bg-border-strong hover:bg-bg-muted rounded-xl py-3 px-4 border-2 border-border">
              <div className="w-8 h-8 bg-brand-muted rounded-lg flex items-center justify-center">
                <span className="text-text-muted font-bold text-lg">A</span>
              </div>
